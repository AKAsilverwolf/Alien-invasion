...
| `build_game.py` | 跨平台 | Python实现、详细错误处理 | **推荐主力** |
| `quick_build.bat` | Windows | 快速简洁、适合测试 | **开发测试** |
...
```
dist/
└── AlienInvasion.exe    # 主程序（约10-20MB）
```
...
更多打包信息请参考：
- 📋 [完整打包指南](COMPLETE_PACKAGE_GUIDE.md)
- 🚀 [快速构建指南](QUICK_BUILD.md)
- 📦 [打包说明文档](PACKAGE_README.md)
- 📁 [文件作用说明](FILE_GUIDE.md)
