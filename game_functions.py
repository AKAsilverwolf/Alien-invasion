...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets, sound_manager):
    """检查是否有外星人到达了屏幕底端"""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets, sound_manager):
    ...
    # 检查是否有外星人到达屏幕底端
    check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets, sound_manager)
